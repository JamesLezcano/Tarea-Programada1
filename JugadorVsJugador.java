...
/**
 * Este programa crea un juego de cuatro en raya en el cual se puede jugar un jugador contra otro.
 * 
...
{
    /**
     *Este metodo recibe dos nombres en String y dos numeros enteros 
    ...
    public static void main()
    {
        ...
        String jugador2=JOptionPane.showInputDialog(lineas+resultado+"   "+jugador1+"\nNombre jugador 2: \n");
        ...
        while (jugadas < 42)
        {
            ...
            while(jugadas%2!=0)
            {
               ...
               int ficha2=0;
                ...
                {
                    ficha2=Integer.parseInt(JOptionPane.showInputDialog(lineas+resultado+"\n\n   Turno de "+ jugador2+"      "+ (jugadas) +" movimientos"+". \n  Ingrese la posicion deseada: \n "));
                }
